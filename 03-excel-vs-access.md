...
| Kutató\_ID (PK) | Név | Email | Intézmény |
| --- | --- | --- | --- |
| 1 | Kovács János | [kovacs@elte.hu](mailto:kovacs@elte.hu) | ELTE BTK |
| 2 | Nagy Anna | [nagy@ppk.hu](mailto:nagy@ppk.hu) | PPKE BTK |

**LÁTOGATÁSOK tábla:**

| Látogatás\_ID (PK) | Kutató\_ID (FK) | Dátum | Megjegyzés |
| --- | --- | --- | --- |
...
| Kérés\_ID (PK) | Látogatás\_ID (FK) | Fond\_ID (FK) |
| --- | --- | --- |
| 1 | 101 | 5 |
| 2 | 101 | 7 |
| 3 | 102 | 5 |
...
**Kapcsolatok:**
- KUTATÓK ↔︎ LÁTOGATÁSOK: 1:N (egy kutató → több látogatás)
- LÁTOGATÁSOK ↔︎ IRATOK: N:M (kapcsoló táblával)
...
#### Hogyan épül fel a relációs struktúra Excelben?
...
| Kutató\_ID | Név | Email | Intézmény |
| --- | --- | --- | --- |
| 1 | Kovács János | [kovacs@elte.hu](mailto:kovacs@elte.hu) | ELTE BTK |
| 2 | Nagy Anna | [nagy@ppk.hu](mailto:nagy@ppk.hu) | PPKE |

**`Iratok` munkalap** – minden fond egyszer, egy sorban:

| Fond\_ID | Jelzet | Fond\_neve |
| --- | --- | --- |
...
| Látogatás\_ID | Kutató\_ID | Dátum | Fond\_ID | Kutató\_neve *(képlet)* | Jelzet *(képlet)* |
| --- | --- | --- | --- | --- | --- |
...
Két munkalap: KUTATÓK (Kutató\_ID, Név) és LÁTOGATÁSOK (Látogatás\_ID, Kutató\_ID, Dátum).
...
- **Hibakezelés:** #HIÁNYZIK hibák, ha nincs találat
...
**Access táblák:**
- KUTATÓK (Kutató\_ID, Név, Email, Téma)
- Iratok (Fond\_ID, Jelzet, Megnevezés)
- LÁTOGATÁSOK (Látogatás\_ID, Kutató\_ID, Dátum)
- KÉRÉSEK (Kérés\_ID, Látogatás\_ID, Fond\_ID) - kapcsoló tábla N:M-hez
...
1. **Húzzuk** Kutató\_ID-t KUTATÓK-ból → LÁTOGATÁSOK-ba
...
- Nem írhatunk be nem létező Kutató\_ID-t
...
- **Példa:** Kutató\_ID = 1 → 100 megváltozik → Access automatikusan átírja az összes Látogatás.Kutató\_ID = 1-et 100-ra
